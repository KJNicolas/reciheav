...
function Meals() {
  ...
  return (
    <div className={classes.meals__page}>
      <SearchBar searchText={searchText} setSearchText={setSearchText} placeholder="search here..." />
      <PointText className={classes.text}>search an intense selection of recipes or just pick one below</PointText>
